...
let AddTask = (props) => {
    ...
    let submitTask = useCallback(() => {
        if (!taskName || !taskDescription) {
            ...
            categories[selectedValue].push({title: taskName, description: taskDescription, category: selectedValue})
    ...
    return (
        <View style={styles.container}>
            ...
            />
            {error && !taskName && <Text style={{ color: '#f00', marginLeft: 10}}>* Title is required</Text>}
            <TextInput
                style={styles.formItem}
            ...
            />
            {error && !taskDescription && <Text style={{ color: '#f00', marginLeft: 10}}>* Description is required</Text>}
